...
const About = () => {
  ...
  <Card.Body>
    <Card.Title>Muhammad Junaid</Card.Title>
    <Card.Text>
 ...
 <Button variant="primary"><a className='text-white text-decoration-none' href="https://github.com/MJunaid739/Junaid-Driving-School.git">Checkout My Github</a></Button>
  </Card.Body>
</Card>
        </div>
    );
